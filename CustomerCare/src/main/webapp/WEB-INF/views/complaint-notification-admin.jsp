...
<div class="container-my">
	...
	<div class="center-div-complaint-admin">
		...
		<div class="div-sorting-complaints-admin">
			...
			<div class="sort-btn">
				<a href="/admin-login/page/${currentPage}?sortBy=complaintId&sortDir=${sortDir}">Complaint Id</a>
			</div>
			<div class="sort-btn">
				<a href="/admin-login/page/${currentPage}?sortBy=analyst.analystId&sortDir=${sortDir}">Analyst Id</a>
			</div>
			<div class="sort-btn">
				<a href="/admin-login/page/${currentPage}?sortBy=dateOfComplaint&sortDir=${sortDir}">Date</a>
			</div>
			<div class="sort-btn">
				<a href="/admin-login/page/${currentPage}?sortBy=category&sortDir=${sortDir}">Category</a>
			</div>
		</div>
		...
		<div class="pagination-details">
			...
			<div>
				<c:forEach var="i" begin="1" end="${totalPages}">
					<a href="/admin-login/page/${i}?sortBy=${sortBy}&sortDir=${sortDir}">${i}</a>
				</c:forEach>
			</div>
		</div>
